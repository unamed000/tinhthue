<link href="<?= base_url('assets/libraries/foundation/css/foundation.min.css') ?>" rel="stylesheet"/>
<link href="<?= base_url('assets/libraries/foundation/css/normalize.css') ?>" rel="stylesheet"/>
<link href="<?= base_url('assets/libraries/font_awesome/css/font-awesome.min.css') ?>" rel="stylesheet"/>
<link href="<?= base_url('assets/libraries/sweetalert/sweetalert.css') ?>" rel="stylesheet"/>
